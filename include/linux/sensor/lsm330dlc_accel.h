...
/* For MAX registers array */
#define LSM330DLC_ACCEL_MAX_REGISTER    40
struct lsm330dlc_register {
    int8_t reg[LSM330DLC_ACCEL_MAX_REGISTER];
};
...
#define LSM330DLC_ACCEL_IOCTL_GET_REGISTER  \
    _IOWR(LSM330DLC_ACCEL_IOCTL_BASE, 2, struct lsm330dlc_register)
#define LSM330DLC_ACCEL_IOCTL_SET_RANGE \
    _IOW(LSM330DLC_ACCEL_IOCTL_BASE, 3, int8_t)
